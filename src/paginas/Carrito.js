            ...
            <div className="contcarrito">
                ...
                <div className="elemento2">
                    <div className="contentfactura">
                        <div className="elementofactura fondogris">Total items: 
                        <p>{totalitems}</p>
                        </div>
                        <div className="elementofactura fondomenosgris">Valor total de tu compra 
                        <p>$ {totalcompra.toLocaleString('es-CO')}</p>
                        </div>
                        <p className="fondogris">Seleccione el medio de pago</p>
                        <div className="elementofactura fondomenosgris ">
                            <img className="imagen" src="https://upload.wikimedia.org/wikipedia/commons/7/72/MasterCard_early_1990s_logo.png" alt=""/>
                           <img className="imagen" src="https://s3.amazonaws.com/nequi-wp-colombia/wp-content/app/wp-content/uploads/2019/08/QR-B.png" alt=""/>
